...
| Orchestration | Small local Python or Node service | Owns wake phrase detection, prompts, context, state, and avatar triggers. |
...
transcripts and responses to the console, speak the response through TTS, and
expose a simple trigger that Warudo or OBS can react to.
